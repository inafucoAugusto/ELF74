...
Repositório destinado a pratica 2 da disciplina de Sistemas Embarcados, turma ELF74, ministrada na Universidade Tecnológica Federal do Paraná (UTFPR). 
...
Adicionando o símbolo __FPU_USED em Options → C/C++ Compiler e adicionando o seguinte trecho de código ao início da função main(), pode-se fazer as seguintes análises:
...
![](/images/stack_register_2_float)

Valores atuais de LR e Control:

![](/images/lr_control_2_float)
...
![](/images/nmipendset_ok)

Continuação do programa (travamento devido ao break point em SysTick_Handler):
